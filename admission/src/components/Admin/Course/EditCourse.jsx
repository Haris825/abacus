...
function EditCourse() {
  ...
  useEffect(() => {
    fetch(`http://localhost:5049/admin/GetCourse/${id}`)
  ...
  const handleUpdate = () => {
    const updatedCourse = {
      ...
      courseEnrolled: document.getElementById('editCourseEnrolled').value,
    ...
    fetch(`http://localhost:5049/admin/editCourse/${id}`, {
      method: 'PUT',
      headers: {
