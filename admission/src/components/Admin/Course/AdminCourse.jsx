...
function AdminCourse() {
  ...
  useEffect(() => {
    fetch('http://localhost:5049/admin/viewCourse')
  ...
  const handleDelete = (courseId) => {
    fetch(`http://localhost:5049/admin/deleteCourse/${courseId}`, {
      method: 'DELETE',
    })
      .then((response) => response.json())
      .then((data) => {
        ...
        {courses.map((course) => (
          <div className="card mb-3" key={course.id}>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="course-info">
                        ...
                        <span>{course.courseEnrolled}</span>
                      </div>
                      <div className="course-info">
            ...
            <div className="card-actions">
              <button className="btn" onClick={() => handleDelete(course.id)}>
                <FaTrash />
              </button>
              <Link to={`/editCourse/${course.id}`} className="btn">
                <FaPencilAlt />
              </Link>
            </div>
          </div>
